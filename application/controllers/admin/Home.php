...
class Home extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            $this->data['title'] = 'Admin Panel | ' . $this->data['system_settings']['app_name'];
            $this->data['meta_description'] = 'Admin Panel | ' . $this->data['system_settings']['app_name'];
    ...
    public function profile()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            $settings = $this->data['system_settings'];
