            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6">
                        ...
                        <div class="col-12 col-sm-12 text-sm">
                            <h6 class="my-3"><?= 'Restaurant Name : <span class="text-primary">' . ucfirst($product_details[0]['partner_details'][0]['partner_name']) . '</span>' ?></h6>
                        </div>
                        <div class="col-12 col-sm-12 text-sm">
                            <h6 class="my-3"><?= 'Owner Name : <span class="text-primary">' . ucfirst($product_details[0]['partner_details'][0]['owner_name']) . '</span>' ?></h6>
                        </div>
