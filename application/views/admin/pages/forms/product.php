                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group ">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" id="pro_input_text" placeholder="Product Name" name="pro_input_name" value="<?= isset($product_details[0]['name']) ? stripslashes(stripslashes(stripslashes(@$product_details[0]['name']))) : ""; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
