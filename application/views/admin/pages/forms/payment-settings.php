                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <input type="text" class="form-control" name="paypal_client_id" value="<?= (isset($settings['paypal_client_id'])) ? $settings['paypal_client_id'] : '' ?>" placeholder="Paypal Client Id" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <input type="text" class="form-control" name="paypal_secret_key" value="<?= (isset($settings['paypal_secret_key'])) ? $settings['paypal_secret_key'] : '' ?>" placeholder="Paypal Serect Key" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="phonepe_salt_index" value="<?= isset($settings['phonepe_salt_index']) ?>" placeholder="Salt index" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
