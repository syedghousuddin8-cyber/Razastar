                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 form-group">
                                                <label for="menifest_logo">Manifest Logo<span class='text-danger text-xs'>*</span><small> ( Manifest logo should be 192 x 192 and file type should be png )</small></label>
                                                <div class="col-sm-10">
                                                    <div class='col-md-3'><a class="uploadFile img btn btn-primary text-white btn-sm" data-input='menifest_logo' data-isremovable='0' data-is-multiple-uploads-allowed='0' data-toggle="modal" data-target="#media-upload-modal" value="Upload Photo"><i class='fa fa-upload'></i> Upload</a></div>
                                                    <?php
                                                    if (!empty($menifest_logo)) {
                                                    ?>
                                                        <label class="text-danger mt-3">*Only Choose When Update is necessary</label>
                                                        <div class="container-fluid row image-upload-section">
                                                            <div class="col-md-3 col-sm-12 shadow p-3 mb-5 bg-white rounded m-4 text-center grow image">
                                                                <img class="img-fluid mb-2" src="<?= BASE_URL() . $menifest_logo ?>" alt="Image Not Found">
                                                                <input type="hidden" name="menifest_logo" id='menifest_logo' value='<?= $menifest_logo ?>'>
                                                            </div>
                                                        </div>
                                                    <?php
                                                    } else { ?>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 col-sm-12">
                                        <label for="is_ridre_otp_setting_on"> Enable / Disable</label>
                                        <div class="card-body">
