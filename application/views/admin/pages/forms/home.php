                ...
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <p>Orders</p>
                            <a href="<?= base_url('admin/orders/') ?>" class="small-box-footer text-info">More info <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <p>New Signups</p>
                            <a href="<?= base_url('admin/customer/') ?>" class="small-box-footer text-info">More info <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <p>Riders</p>
                            <a href="<?= base_url('admin/riders/manage-rider') ?>" class="small-box-footer text-info">More info <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <p>Partners</p>
                            <a href="<?= base_url('admin/partners/') ?>" class="small-box-footer text-info">More info <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
