                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/custom_notification/add_notification'); ?>" method="POST" id="add_product_form" enctype="multipart/form-data">
                            ...
                            <div class=" card-body">
                                <?php
                                $type = ['place_order', 'customer_order_pending', 'customer_order_confirm', 'customer_order_preparing', 'customer_order_out_for_delivery', 'customer_order_cancelled', 'customer_order_delivered', 'rider_assign_order', 'rider_pending_order', 'cart_notification'];
                                ?>
                                ...
                                <div class="form-group row cart_notification <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['type'] == 'cart_notification') ? '' : 'd-none' ?>">
                                    <label for="message" class="col-sm-2 col-form-label"></label></label>
                                    <?php
                                    $hashtag = ['< application_name >'];
                                    foreach ($hashtag as $row) { ?>
