                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/riders/add_rider'); ?>" method="POST" id="add_product_form">
                            <?php if (isset($fetched_data[0]['id'])) { ?>
                                <input type="hidden" name="old_rider_email" value="<?= @$fetched_data[0]['email'] ?>">
                                <input type="hidden" name="old_rider_mobile" value="<?= @$fetched_data[0]['mobile'] ?>">
                            <?php
                            }
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="serviceable_city[]" class="serviceable_cities search_city w-100" multiple onload="multiselect()">
