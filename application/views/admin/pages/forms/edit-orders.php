                                            ...
                                            <div class="card card-widget widget-user-2">
                                                ...
                                                <div class="card-footer p-0">
                                                    <ul class="nav flex-column">
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="javascript:void(0)" class="nav-link text-info">User Wallet Balance(<?= $settings['currency'] ?>)<span class="float-right text-info"><?= isset($order_detls[0]['user_balance']) ? number_format(floatval($order_detls[0]['user_balance']), 2) : ""; ?></span>
                                                            </a>
                                                        </li>
                                                        <li class="nav-item">
                                                        ...
                                                        <?php if ($order_detls[0]['is_self_pick_up'] !== '1' && $order_detls[0]['is_self_pick_up'] !== 1) { ?>
                                                            <li class="nav-item">
                                            ...
                                            <div class="card card-widget widget-user-2">
                                                ...
                                                <div class="card-footer p-0">
                                                    <ul class="nav flex-column">
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="javascript:void(0)" class="nav-link text-info">Promo Code<span class="float-right text-info"><?= isset($order_detls[0]['promo_code']) && !empty($order_detls[0]['promo_code']) ? $order_detls[0]['promo_code'] : ""; ?></span></a>
                                                        </li>
                                                        <li class="nav-item">
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="javascript:void(0)" class="nav-link bg-info">
                                                                <?php $total_final = (float)$total + (float)$order_detls[0]['tax_amount']; ?>
                                                                Payable Total(<?= $settings['currency'] ?>) <span class="float-right"><?= number_format($total_final, 2); ?></span>
                                                            </a>
                                                        </li>
