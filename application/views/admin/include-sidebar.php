        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <!-- <li class="nav-item">
                    <a href="<?= base_url('admin/payment_statistics/') ?>" class="nav-link <?= is_url_active('admin/payment_statistics') ? 'active' : '' ?>">
                        <i class="nav-icon fas fa-money-bill-wave text-primary"></i>
                        <p>
                            Payment Statistics
                        </p>
                    </a>
                ...
                <?php if (has_permissions('read', 'rider') || has_permissions('read', 'fund_transfer')) { ?>
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <?php if (has_permissions('read', 'rider')) { ?>
                                <li class="nav-item">
                                    <a href="<?= base_url('admin/riders/rider-live-status') ?>" class="nav-link ">
                ...
                if (!empty($userData)) {
                    ...
                    if ($userData[0]['role'] == 0) { ?>
                        ...
                        <!-- <li class="nav-item mb-4">
                            <a href="<?= base_url('admin/transaction/order_settelment_transaction/') ?>" class="nav-link">
                                <i class="nav-icon fas fa-money-bill-wave text-info"></i>
                                <p class="text">Order Settelment Transactions</p>
                            </a>
                        </li> -->
                <?php  }
                } ?>
