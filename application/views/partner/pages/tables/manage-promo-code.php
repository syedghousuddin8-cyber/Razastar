          ...
          <div class="card content-area p-4">
            <div class="card-header border-0">
              <div class="card-tools">
                <a href="<?= base_url() . 'partner/promo-code/' ?>" class="btn btn-block btn-outline-info btn-sm">Add Promo Code</a>
              </div>
            </div>
            <div class="card-innr">
              ...
              <table class='table-striped'
                data-toggle="table"
                data-url="<?= base_url('partner/promo_code/view_promo_code') ?>"
                ...
                <thead>
                  <tr>
                    ...
                    <th data-field="promocode_type" data-sortable="true">Promocode Type</th>
