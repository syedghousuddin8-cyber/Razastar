...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <form class="form-horizontal form-submit-event" action="<?= base_url('partner/login/update_user'); ?>"
                method="POST">
                <?php if (isset($fetched_data[0]['id'])) { ?>
                    ...
                    <input type="hidden" name="commission" value="<?= $fetched_data[0]['commission'] ?>">
                    ...
                    <input type="hidden" name="customer_privacy"
                        value="<?= (isset($permit['customer_privacy']) && $permit['customer_privacy'] == '1') ? 1 : 0 ?>">
                    <input type="hidden" name="view_order_otp"
                        value="<?= (isset($permit['view_order_otp']) && $permit['view_order_otp'] == '1') ? 1 : 0 ?>">
                    <input type="hidden" name="is_email_setting_on"
                        value="<?= (isset($permit['is_email_setting_on']) && $permit['is_email_setting_on'] == '1') ? 1 : 0 ?>">
                    <input type="hidden" name="assign_rider"
                        value="<?= (isset($permit['assign_rider']) && $permit['assign_rider'] == '1') ? 1 : 0 ?>">
                <?php } ?>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <div class=" pt-2 mb-2">
                                        ...
                                        <div class="col-sm-1">
                                            <input type="checkbox" name="delivery_orders"
                                                <?= (isset($permit['delivery_orders']) && $permit['delivery_orders'] == '1') ? 'Checked' : '' ?>
                                    ...
                                    <div class=" pt-2 mb-2">
                                        ...
                                        <div class="col-sm-1">
                                            <input type="checkbox" name="self_pickup" <?= (isset($permit['self_pickup']) && $permit['self_pickup'] == '1') ? 'Checked' : '' ?>
                                                data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                        </div>
                                    </div>
                                    <div class=" pt-2 mb-2">
                                        <label for="global_restaurant_time" class="col-sm-8 form-label">Global
                                            Restaurant Time </label>
                                        <div class="col-sm-1">
                                            <input type="checkbox" name="global_restaurant_time"
                                                <?= (isset($fetched_data[0]['global_restaurant_time']) && $fetched_data[0]['global_restaurant_time'] == '1') ? 'Checked' : '' ?>
                                                data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                        </div>
                                    </div>
                                </div>
                                                        ...
                                                        <ul class="nav flex-column">
                                                            <li class="nav-item">
                                                                <a href="javascript:void(0)"
                                                                    class="nav-link category-order partner-profile"
                                                                    id="partner_profile">Admin
                                                                    Commission<?= " -> " . @$fetched_data[0]['commission'] . "(%)" ?></a>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a href="javascript:void(0)"
                                                                    class="nav-link category-order partner-profile"
                                                                    id="partner_profile">View Customer's
                                                                    Details?<?= (isset($permit['customer_privacy']) && $permit['customer_privacy'] == '1') ? '<label class="float-right badge badge-success">Yes</label>' : '<label class=" float-right badge badge-danger">No</label>' ?></a>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a href="javascript:void(0)"
                                                                    class="nav-link category-order partner-profile"
                                                                    id="partner_profile">View Order's
                                                                    OTP?<?= (isset($permit['view_order_otp']) && $permit['view_order_otp'] == '1') ? '<label class="float-right badge badge-success">Yes</label>' : '<label class="float-right badge badge-danger">No</label>' ?></a>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a href="javascript:void(0)"
                                                                    class="nav-link category-order partner-profile"
                                                                    id="partner_profile">Can assign Rider? & Can change deliver status?<?= (isset($permit['assign_rider']) && $permit['assign_rider'] == '1') ? '<label class=" float-right badge badge-success">Yes</label>' : '<label class="float-right badge badge-danger">No</label>' ?></a>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a href="javascript:void(0)"
                                                                    class="nav-link category-order partner-profile"
                                                                    id="partner_profile">Email Notification?
                                                                    <?= (isset($permit['is_email_setting_on']) && $permit['is_email_setting_on'] == '1') ? '<label class="float-right badge badge-success">Yes</label>' : '<label class="float-right badge badge-danger">No</label>' ?></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="partner_name"
                                                    ...
                                                    value="<?= @$fetched_data[0]['partner_name'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 map-div">
                                                ...
                                                <span class="text text-primary">Search your partner name and you will
                                                    get the location points(Latitude & Longitude) below.</span>
                                            </div>
                                            <div class="col-md-8">
                                                <div id="map"></div>
                                            ...
                                            <div id="status" class="btn-group col-sm-8">
                                                ...
                                                <label class="btn btn-primary" data-toggle-class="btn-primary"
                                                    ...
                                                    <input type="radio" name="status" value="1"
                                                        <?= (isset($fetched_data[0]['status']) && $fetched_data[0]['status'] == '1') ? 'Checked' : '' ?>> Active
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="password" class="form-control" id="old"
                                                    placeholder="Type Password here" name="old">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="password" class="form-control" id="new"
                                                    placeholder="Type Password here" name="new">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="new_confirm" class="col-sm-4 col-form-label">Confirm New
                                                Password</label>
                                            <div class="col-sm-10">
                                                <input type="password" class="form-control" id="new_confirm"
                                                    placeholder="Type Confirm Password here" name="new_confirm">
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-info" id="submit_btn">Update
                                                Profile</button>
                                        </div>
                                    </div>
                                </div>
