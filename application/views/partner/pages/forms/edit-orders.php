                    ...
                    <div class="card card-info">
                        <div class="card-body">
                            ...
                            foreach ($items as $item) {
                                ...
                                $tax_amount += number_format((int)$item['tax_amount']);
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="javascript:void(0)" class="nav-link text-info">Email
                                                                <?php if (isset($order_detls[0]['email']) && !empty($order_detls[0]['email'])) { ?>
                                                                    <span class="float-right text-info"><?= ((defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) || (get_partner_permission($partner_id, 'customer_privacy') == FALSE)) ? str_repeat("X", strlen($order_detls[0]['email']) - 3) . substr($order_detls[0]['email'], -3) : $order_detls[0]['email']; ?>
                                                                    </span>
                                                                <?php } ?>
                                                            </a>
                                                        </li>
                                ...
                                <div class="col-md-6">
                                    <table class="table table-borderless">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="status" id="status" class="form-control" data-isjson="true" data-orderid="<?= $order_detls[0]['order_id']; ?>">
                                                        ...
                                                        <?php } ?> <?php if (get_partner_permission($partner_id, 'assign_rider')) { ?>
                                            ...
                                            <?php if (isset($order_detls[0]['is_self_pick_up']) && !empty($order_detls[0]['is_self_pick_up']) && $order_detls[0]['is_self_pick_up'] == 1) { ?>
                                                <tr class="">
                                                    <th class="col-3">Owner Note for Self Pickup</th>
                                                    <td>
