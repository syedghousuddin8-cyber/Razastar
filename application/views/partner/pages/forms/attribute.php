            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        <!-- form start -->
                        <form class="form-horizontal form-submit-event" action="<?= base_url('partner/attributes/add_attributes'); ?>" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body p-0">
                                <form class="form-horizontal" id="edit-attributes-form" action="<?= base_url('partner/attributes/add_attributes'); ?>" method="POST" enctype="multipart/form-data">
                                    <div class="card-body">
