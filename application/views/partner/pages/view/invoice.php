<div class="content-wrapper">
    ...
    $partners = array_values(array_unique(array_column($order_detls, "partner_id"))); ?>
                ...
                <div class="col-md-12">
                    <div class="card card-info " id="section-to-print">
                                ...
                                <div class="row m-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <?php if (isset($order_detls[0]['is_self_pick_up']) && empty($order_detls[0]['is_self_pick_up'])) { ?>
                                            ...
                                            <p>Delivery Tip (<?= $settings['currency'] ?>) : <?= (isset($order_detls[0]['delivery_tip']) && !empty($order_detls[0]['delivery_tip'])) ? $order_detls[0]['delivery_tip'] : "0"; ?></p>
                                        <?php } else { ?>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless">
                                        <tbody>
                                            ...
                                            $oredr_total = number_format($order_detls[0]['order_total'], 2);
                                            $tax_amount = $oredr_total * ($tax_per / 100);
                                            ?>
                                            <tr>
                                                <th></th>
                                            </tr>
                                            <tr class="">
                                                ...
                                                <td>+
                                                    <?php echo $settings['currency'] . ' ' . number_format($tax_amount, 2); ?>
                                                </td>
                                            </tr>
                                            <tr>
                        ...
                        <div class="row m-3" id="section-not-to-print">
                            ...
                            <div class="col-md-6">
                                <a type="button" class="btn btn-default" href="<?= base_url('partner/invoice/partner_thermal_invoice?edit_id=' . $items[0]['order_id']) ?>"><i class="fa fa-print"></i> Thermal Print</a>
                            </div>
                        </div>
                    </div>
                    <!--/.card-->
