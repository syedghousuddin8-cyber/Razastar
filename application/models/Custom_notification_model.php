...
class Custom_notification_model extends CI_Model
{
    ...
    public function get_custom_notifications_data($offset = 0, $limit = 10, $sort = 'id', $order = 'ASC')
    {
        ...
        foreach ($city_search_res as $row) {
            ...
            $operate .= '<a href="javascript:void(0)" class="edit_btn action-btn btn btn-primary btn-xs mr-1 mb-1 ml-1" data-id="' . $row['id'] . '" data-url="admin/custom_notification" title="Edit Notification" ><i class="fa fa-pen"></i></a>';
